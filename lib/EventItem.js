    ...
    _createClass(EventItem, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                resourceCategory = _props.resourceCategory;
            ...
            var eventItemTemplate = _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'span',
                    { className: resourceType, id: '' + (eventItem.state && eventItem.state.type ? eventItem.state.type[0].toUpperCase() : '') },
                    eventItem.state && eventItem.state.type ? eventItem.state.type === 'Work Order' ? 'WO' : eventItem.state.type[0].toUpperCase() : ''
                ),
                _react2.default.createElement(
                    'span',
                    { className: resourceCategory },
                    eventItem.state ? eventItem.state.reportCategory : ''
                )
            );
