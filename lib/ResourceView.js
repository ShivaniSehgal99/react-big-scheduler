    ...
    _createClass(ResourceView, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                handleClickResource = _props.handleClickResource,
                resourceStatus = _props.resourceStatus;
            ...
            var resourceList = displayRenderData.map(function (item) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'td',
                        { 'data-resource-id': item.slotId, style: tdStyle, className: item.grandParentClass },
                        slotItem,
                        _react2.default.createElement(
                            'div',
                            { className: item.parentClass, onClick: function onClick() {
                                    return handleClickResource(item);
                                } },
                            _react2.default.createElement('div', { className: item.childClass })
                        ),
                        resourceStatus && item.slotId === resourceStatus.slotId && _react2.default.createElement(
                            'div',
                            { className: 'status-list' },
                            resourceStatus.resourceStatusComponent
                        )
                    )
                );
            });
